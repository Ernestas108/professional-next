...
const fmt = new Intl.NumberFormat("lt-LT", {
    style: "currency",
    currency: "EUR",
});
...
export default function CartDrawer() {
    ...
    // kai atidarytas krepšelis – užrakinti body scroll
    useEffect(() => {
        if (isOpen) {
            ...
            >
                                    ...
                                    <div className="min-w-0 flex-1">
                                        ...
                                        <div className="mt-2 flex items-center gap-2">
                                            ...
                                            <button
                                                ...
                                                className="ml-auto text-sm px-2 py-1 rounded border border-slate-300 hover:bg-slate-100"
                                                title="Pašalinti"
                                            >
                                                Pašalinti
                                            </button>
                ...
                <footer className="p-4 border-t border-slate-200">
                    ...
                    <div className="mt-3 flex gap-2">
                        ...
                        <button
                            onClick={() => {
                                // paprastas demo „apmokėjimas“
                                alert("Ačiū! (demo)");
                                close();
                            }}
                            className="flex-1 px-3 py-2 rounded-md bg-blue-600 hover:bg-blue-500 text-white"
                        >
                            Apmokėti
                        </button>
                    </div>
